...
> * photo: CharField (max 254, optional)
...
## Planned Changes:
* Testing
* Docstrings for all custom types/queries/mutations
* A change from regular GraphQL objects to nodes using Relay. IDs are alreayd globally-unique UUIDs.

## Changelog:
1. 7/10/2021: Initial version of the backend